      ...
      <div className='container mx-auto p-5  text-white font-mono' id='aboutme'>
        <div className='font-normal w-full mx-auto lg:w-1/2 text-xl flex justify-center py-5 flex-col'>
          <p className='font-sans'>
            My name is Ivaylo and I am a Web Developer based in London. I have experience building
            projects with lots of up-to-date technologies such as HTML CSS JS React Next.js
