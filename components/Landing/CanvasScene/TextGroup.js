...
const TextGroup = () => {
  ...
  return (
    <group ref={groupRef} scale={(0.2 * width) / height} position={[width > 5 ? width * -0.7 : width * -0.6, height > 5 ? 1.2 : 1.5, 0]}>
      <Float floatIntensity={0.3} rotationIntensity={0.3}>
        <group ref={titleRef} scale={1}>
          <Text size={1} hAlign='right' rotation={[0.1, 0.4, 0]} position={[0, 3, -20]} children='IVAYLO' />
          <Text size={1} hAlign='right' rotation={[0.1, 0.4, 0]} position={[0, -1.5, -20]} children='KORCHEV' />
        </group>
        <group ref={subtitleRef} position={[0, -2, 0]} scale={1}>
          <Text size={0.5} hAlign='right' rotation={[0, 0.4, 0]} colors={['#89a19d', '#89a19d', '#89a19d']} position={[0, -4.5, -20]} children='FRONT END' />
          <Text size={0.5} hAlign='right' rotation={[0, 0.4, 0]} colors={['#89a19d', '#89a19d', '#89a19d']} position={[0, -6.5, -20]} children='DEVELOPER' />
        </group>
      </Float>
